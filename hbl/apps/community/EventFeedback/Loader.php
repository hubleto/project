...
class Loader extends \HubletoMain\Core\App
{
  ...
  public function init(): void
  {
    ...
    // $appMenu->addItem($this, 'eventfeedback/item-1', $this->translate('Item 1'), 'fas fa-table');
    // $appMenu->addItem($this, 'eventfeedback/item-2', $this->translate('Item 2'), 'fas fa-list');
  }
